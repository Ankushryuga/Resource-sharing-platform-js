...
const taskName =
  "This is dummy task for just for testing purpose and later on will be fetching from backend server, so for now just use this dummy task please, and thank you for cordinating.";
        ...
        >
          <div className="flex-1 overflow-y-auto space-y-1 p-4 hide-scrollbar bg-transparent">
            <span className="text-xs font-bold text-gray-700 flex gap-5">
              <SiTask className="text-2xl transition" />#{taskId}
            </span>
            <h3
              className="text-sm pl-10 font-semibold text-gray-800 truncate"
              title={taskName}
            >
              {taskName}
            </h3>
           ...
           gap-2 pt-5 cursor-pointer hover:opacity-80 transition"
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="pl-50 items-center gap-4 flex">
                      ...
                      <motion.span
                        className="inline-flex items-center justify-center px-10 py-2 rounded-md text-white font-semibold text-xs shadow-md"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="pl-40 items-center gap-4 flex">
                      ...
                      <motion.span className="inline-flex items-center justify-center py-2 text-black font-semibold text-xs">
                        Unresolved
                      </motion.span>
                    </div>
                  </div>
            ...
            <div
              onClick={() => setAttachmentExpand(!attachmentExpand)}
              className="flex items-center gap-2 pt-5 cursor-pointer hover:opacity-80 transition"
            >
              {attachmentExpand ? (
                <MdKeyboardArrowDown className="text-xl text-gray-700" />
    ...
    This is a very long text that will be trimmed and won't wrap to the next line.
                  ...
                  <div className="flex justify-center items-center w-full p-4 bg-white border border-gray-300 rounded-md shadow-sm gap-2">
                    ...
                    <p className="truncate text-sm text-gray-800">
                      This box has a subtle trim using border.
                    </p>
                  </div>
                </motion.div>
              </AnimatePresence>
              ...
              <AnimatePresence>
                ...
                >
                  <div className="flex items-center gap-10">
                    <button className="text-sm text-gray-700 font-medium bg-white border-none">
                      History
                    </button>
                    <button className="text-sm text-gray-700 font-medium bg-white border-none">
                      Attachments
      ...
      <div className="w-1/4">
        <div
          onClick={() => setPeopleExpand(!peopleExpand)}
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-2 text-sm text-black">
                  ...
                  <span>
                    Ankush raj <span className="text-blue-600">(me)</span>
                  </span>
                </div>
              </div>
